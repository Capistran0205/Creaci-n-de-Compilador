...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed May 28 11:26:49 CST 2025
  */
  ...
  public int error_sym() {return 1;}
    ...
    public void report_error(String message, Object info) {
        ...
        if (info instanceof Symbol) {
            ...
            // Agregar información sobre el token si está disponible
            if (s.value != null) {
    ...
    public void report_fatal_error(String message, Object info) {
        ...
        // No lanzar excepción aquí para permitir que se recopilen más errores
    }

    // Método para agregar errores personalizados
    public void agregarError(String mensaje, int linea, int columna) {
        String error = String.format("Error en línea %d, columna %d: %s", linea + 1, columna + 1, mensaje);
        errores.add(error);
    }
